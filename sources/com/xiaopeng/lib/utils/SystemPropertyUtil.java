...
public class SystemPropertyUtil {
    ...
    public static void setAiosWakeUpEnable(boolean z) {
        SystemProperties.set(SYSTEM_PROPERTY_AIOS_WAKEUP, z ? BuildInfoUtils.BID_WAN : ChargeRepository.DEFAULT_ENDURANCE_VALUE);
    }
    ...
    public static void setInCall(boolean z) {
        SystemProperties.set(SYSTEM_PROPERTY_CALLING, z ? BuildInfoUtils.BID_WAN : ChargeRepository.DEFAULT_ENDURANCE_VALUE);
    }
