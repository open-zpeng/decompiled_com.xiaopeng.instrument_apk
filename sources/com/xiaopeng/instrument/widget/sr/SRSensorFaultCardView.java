...
import com.xiaopeng.instrument.viewmodel.sr.SRSensorFaultViewModel;
...
public class SRSensorFaultCardView extends XRelativeLayout implements IBaseCustomView {
    private static final int SPACE = 16;
    public static final String TAG = "SRSensorFaultCardView";
    ...
    private SRSensorFaultViewModel mViewModel;

    public SRSensorFaultCardView(Context context) {
        this(context, null);
    }

    public SRSensorFaultCardView(Context context, AttributeSet attributeSet) {
        super(context, attributeSet);
        this.mSensorImageViewMap = new HashMap();
        init(context);
    }

    public SRSensorFaultCardView(Context context, AttributeSet attributeSet, int i) {
    ...
    public void onAttachedToWindow() {
        ...
        SRSensorFaultViewModel sRSensorFaultViewModel = this.mViewModel;
        if (sRSensorFaultViewModel != null) {
            sRSensorFaultViewModel.resumeData();
        }
    }

    private void init(Context context) {
        this.mContext = context;
        LayoutInflater.from(getContext()).inflate(R.layout.info_card_sensor_fault_sr, this);
    ...
    private void initViewModel() {
        ...
        SRSensorFaultViewModel sRSensorFaultViewModel = (SRSensorFaultViewModel) new ViewModelProvider((ViewModelStoreOwner) getContext()).get(SRSensorFaultViewModel.class);
        this.mViewModel = sRSensorFaultViewModel;
        setLiveDataObserver(sRSensorFaultViewModel.getTextLiveData(), new Observer() { // from class: com.xiaopeng.instrument.widget.sr.-$$Lambda$SRSensorFaultCardView$oX_-x0qxfHXruXNjJ4G8CTIquSk
            @Override // androidx.lifecycle.Observer
            public final void onChanged(Object obj) {
                SRSensorFaultCardView.this.showText((String) obj);
            }
        });
        setLiveDataObserver(this.mViewModel.getSensorContainBeanLiveData(), new Observer() { // from class: com.xiaopeng.instrument.widget.sr.-$$Lambda$SRSensorFaultCardView$DDhxmpq1EZYBrsYMerg4iwg9gf8
            @Override // androidx.lifecycle.Observer
            public final void onChanged(Object obj) {
                SRSensorFaultCardView.this.showSensor((SensorContainBean) obj);
            }
        });
    }
    ...
    private void showSensorView(SensorBean sensorBean, int i, int i2, boolean z) {
        ...
        if (bodyFront != null) {
            ...
            if (i2 != 0) {
                layoutParams.setMargins(bodyFront.getLeft() - 16, bodyFront.getTop() - 16, bodyFront.getRight(), bodyFront.getBottom());
            } else {
