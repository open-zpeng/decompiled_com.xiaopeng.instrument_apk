...
public class CounterImpl implements ICounter, Handler.Callback {
    ...
    public CounterImpl(Context context, String str, long j) {
        ...
        this.mTime = new AtomicLong(defaultSharedPreferences.getLong(generatePrefKey("time"), System.currentTimeMillis()));
    ...
    public synchronized int count(String str, int i) {
        ...
        if (this.mDebug) {
            LogUtils.v(TAG, "count " + this.mName + " " + str + StringUtil.COLON_DELIMITER + i3 + ", cache is:" + this.mCountMap);
        }
